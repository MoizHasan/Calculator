...
evaluateExpression = (event) => {
  ...
  render() {
    return (
      ...
      <section className="primary-buttons">
        <CalculatorButton id="clear" value="C" handler={this.clear} />
        <CalculatorButton id="divide" value="/" handler={this.handleModifier} />
        <CalculatorButton id="multiply" value="x" handler={this.handleModifier} />
        ...
        <CalculatorButton id="zero" value="0" handler={this.handleDigitClick} />
        <CalculatorButton id="decimal" value="." handler={this.handleDecimal} /> 
        <CalculatorButton id="equals" value="=" handler={this.evaluateExpression} />
      </section>
    </div>
    )
  }
